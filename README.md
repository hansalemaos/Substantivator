...
- Practice German nouns from A1-B2
- Practice German genders (der, die, das)
- Practice plural formation of German nouns
- No coding required!
...
| -------------------------------------------------------------- |- |
Start the app and choose how many exercises you want to do.|<img src="33_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 2 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
You can practice gender/plural or gender/plural/declensions|<img src="66_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 3 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
The app will show you the word and the translation of all available<br>languages.|<img src="99_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 4 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
The article of the German word "Anlage" is "die", because its gender<br>is feminine. For each right answer, you will get a point.|<img src="132_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 5 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
The next exercise is writing the plural form of the word.|<img src="165_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 6 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
If your answer is right, you will get a point.|<img src="198_800x800.png" width="400"/> |
